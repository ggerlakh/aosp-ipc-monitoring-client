...
В данной директории приведены только те файлы, которые были подвержены изменению из всего кода AOSP, c сохранением соответствующих отсносительных путей в [исходном коде проекта](https://cs.android.com/android/platform/superproject/main/+/main:).  
